...
class ConversationController {
    async add(req, res) {
        ...
        const addedConversation = await Conversation.create({members: [senderId, receiverId]})
    ...
    async getByConversationsByUserId(req, res) {
        ...
        const userConversations = await Conversation.findAll({where: {members: {[Op.contains]: [userId]}}})
